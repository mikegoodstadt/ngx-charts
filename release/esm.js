...
var HeatMapComponent = /** @class */ (function (_super) {
    ...
    HeatMapComponent = __decorate([
        Component({
            ...
            template: "\n    <ngx-charts-chart\n      ng-attr-[view]=\"{{[width, height]}}\"\n      ng-attr-[showLegend]=\"{{legend}}\"\n      ng-attr-[animations]=\"{{animations}}\"\n      ng-attr-[legendOptions]=\"{{legendOptions}}\"\n      (legendLabelClick)=\"onClick($event)\"\n    >\n      <svg:g ng-attr-[attr.transform]=\"{{transform}}\" class=\"heat-map chart\">\n        <svg:g\n          ngx-charts-x-axis\n          *ngIf=\"xAxis\"\n          ng-attr-[xScale]=\"{{xScale}}\"\n          ng-attr-[dims]=\"{{dims}}\"\n          ng-attr-[showLabel]=\"{{showXAxisLabel}}\"\n          ng-attr-[labelText]=\"{{xAxisLabel}}\"\n          ng-attr-[trimTicks]=\"{{trimXAxisTicks}}\"\n          ng-attr-[rotateTicks]=\"{{rotateXAxisTicks}}\"\n          ng-attr-[maxTickLength]=\"{{maxXAxisTickLength}}\"\n          ng-attr-[tickFormatting]=\"{{xAxisTickFormatting}}\"\n          ng-attr-[ticks]=\"{{xAxisTicks}}\"\n          (dimensionsChanged)=\"updateXAxisHeight($event)\"\n        ></svg:g>\n        <svg:g\n          ngx-charts-y-axis\n          *ngIf=\"yAxis\"\n          ng-attr-[yScale]=\"{{yScale}}\"\n          ng-attr-[dims]=\"{{dims}}\"\n          ng-attr-[showLabel]=\"{{showYAxisLabel}}\"\n          ng-attr-[labelText]=\"{{yAxisLabel}}\"\n          ng-attr-[trimTicks]=\"{{trimYAxisTicks}}\"\n          ng-attr-[maxTickLength]=\"{{maxYAxisTickLength}}\"\n          ng-attr-[tickFormatting]=\"{{yAxisTickFormatting}}\"\n          ng-attr-[ticks]=\"{{yAxisTicks}}\"\n          (dimensionsChanged)=\"updateYAxisWidth($event)\"\n        ></svg:g>\n        <svg:rect\n          *ngFor=\"let rect of rects\"\n          ng-attr-[attr.x]=\"{{rect.x}}\"\n          ng-attr-[attr.y]=\"{{rect.y}}\"\n          ng-attr-[attr.rx]=\"{{rect.rx}}\"\n          ng-attr-[attr.width]=\"{{rect.width}}\"\n          ng-attr-[attr.height]=\"{{rect.height}}\"\n          ng-attr-[attr.fill]=\"{{rect.fill}}\"\n        />\n        <svg:g\n          ngx-charts-heat-map-cell-series\n          ng-attr-[xScale]=\"{{xScale}}\"\n          ng-attr-[yScale]=\"{{yScale}}\"\n          ng-attr-[colors]=\"{{colors}}\"\n          ng-attr-[data]=\"{{results}}\"\n          ng-attr-[gradient]=\"{{gradient}}\"\n          ng-attr-[animations]=\"{{animations}}\"\n          ng-attr-[tooltipDisabled]=\"{{tooltipDisabled}}\"\n          ng-attr-[tooltipTemplate]=\"{{tooltipTemplate}}\"\n          ng-attr-[tooltipText]=\"{{tooltipText}}\"\n          (select)=\"onClick($event)\"\n          (activate)=\"onActivate($event, undefined)\"\n          (deactivate)=\"onDeactivate($event, undefined)\"\n        />\n      </svg:g>\n    </ngx-charts-chart>\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush,
            styles: [".ngx-charts{float:left;overflow:visible}.ngx-charts .arc,.ngx-charts .bar,.ngx-charts .circle{cursor:pointer}.ngx-charts .arc.active,.ngx-charts .arc:hover,.ngx-charts .bar.active,.ngx-charts .bar:hover,.ngx-charts .card.active,.ngx-charts .card:hover,.ngx-charts .cell.active,.ngx-charts .cell:hover{opacity:.8;transition:opacity .1s ease-in-out}.ngx-charts .arc:focus,.ngx-charts .bar:focus,.ngx-charts .card:focus,.ngx-charts .cell:focus{outline:0}.ngx-charts .arc.hidden,.ngx-charts .bar.hidden,.ngx-charts .card.hidden,.ngx-charts .cell.hidden{display:none}.ngx-charts g:focus{outline:0}.ngx-charts .area-series.inactive,.ngx-charts .line-series-range.inactive,.ngx-charts .line-series.inactive,.ngx-charts .polar-series-area.inactive,.ngx-charts .polar-series-path.inactive{transition:opacity .1s ease-in-out;opacity:.2}.ngx-charts .line-highlight{display:none}.ngx-charts .line-highlight.active{display:block}.ngx-charts .area{opacity:.6}.ngx-charts .circle:hover{cursor:pointer}.ngx-charts .label{font-size:12px;font-weight:400}.ngx-charts .tooltip-anchor{fill:#000}.ngx-charts .gridline-path{stroke:#ddd;stroke-width:1;fill:none}.ngx-charts .refline-path{stroke:#a8b2c7;stroke-width:1;stroke-dasharray:5;stroke-dashoffset:5}.ngx-charts .refline-label{font-size:9px}.ngx-charts .reference-area{fill-opacity:.05;fill:#000}.ngx-charts .gridline-path-dotted{stroke:#ddd;stroke-width:1;fill:none;stroke-dasharray:1,20;stroke-dashoffset:3}.ngx-charts .grid-panel rect{fill:none}.ngx-charts .grid-panel.odd rect{fill:rgba(0,0,0,.05)}"],
            encapsulation: ViewEncapsulation.None
        })
...
var LineSeriesComponent = /** @class */ (function () {
    ...
    LineSeriesComponent = __decorate([
        Component({
            ...
            template: "\n    <svg:g>\n      <defs>\n        <svg:g ngx-charts-svg-linear-gradient *ngIf=\"hasGradient\"\n          orientation=\"vertical\"\n          ng-attr-[name]=\"{{gradientId}}\"\n          ng-attr-[stops]=\"{{gradientStops}}\"\n        />\n      </defs>\n      <svg:g ngx-charts-area\n        class=\"line-highlight\"\n        ng-attr-[data]=\"{{data}}\"\n        ng-attr-[path]=\"{{areaPath}}\"\n        ng-attr-[fill]=\"{{hasGradient ? gradientUrl : colors.getColor(data.name)}}\"\n        ng-attr-[opacity]=\"{{0.25}}\"\n        ng-attr-[startOpacity]=\"{{0}}\"\n        ng-attr-[gradient]=\"{{true}}\"\n        ng-attr-[stops]=\"{{areaGradientStops}}\"\n        ng-attr-[class.active]=\"{{isActive(data)}}\"\n        ng-attr-[class.inactive]=\"{{isInactive(data)}}\"\n        ng-attr-[animations]=\"{{animations}}\"\n      />\n      <svg:g ngx-charts-line\n        class=\"line-series\"\n        ng-attr-[data]=\"{{data}}\"\n        ng-attr-[path]=\"{{path}}\"\n        ng-attr-[stroke]=\"{{stroke}}\"\n        ng-attr-[animations]=\"{{animations}}\"\n        ng-attr-[class.active]=\"{{isActive(data)}}\"\n        ng-attr-[class.inactive]=\"{{isInactive(data)}}\"\n      />\n     <svg:g ngx-charts-area\n        *ngIf=\"hasRange\"\n        class=\"line-series-range\"\n        ng-attr-[data]=\"{{data}}\"\n        ng-attr-[path]=\"{{outerPath}}\"\n        ng-attr-[fill]=\"{{hasGradient ? gradientUrl : colors.getColor(data.name)}}\"\n        ng-attr-[class.active]=\"{{isActive(data)}}\"\n        ng-attr-[class.inactive]=\"{{isInactive(data)}}\"\n        ng-attr-[opacity]=\"{{rangeFillOpacity}}\"\n        ng-attr-[animations]=\"{{animations}}\"\n      />\n    </svg:g>\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush
        })
    ], LineSeriesComponent);
...
var PolarSeriesComponent = /** @class */ (function () {
    ...
    PolarSeriesComponent = __decorate([
        Component({
            ...
            template: "\n    <svg:g class=\"polar-charts-series\">\n      <defs>\n        <svg:g\n          ngx-charts-svg-radial-gradient\n          *ngIf=\"hasGradient\"\n          orientation=\"vertical\"\n          ng-attr-[color]=\"{{seriesColor}}\"\n          ng-attr-[name]=\"{{gradientId}}\"\n          ng-attr-[startOpacity]=\"{{0.25}}\"\n          ng-attr-[endOpacity]=\"{{1}}\"\n          ng-attr-[stops]=\"{{gradientStops}}\"\n        />\n      </defs>\n      <svg:g\n        ngx-charts-line\n        class=\"polar-series-path\"\n        ng-attr-[path]=\"{{path}}\"\n        ng-attr-[stroke]=\"{{hasGradient ? gradientUrl : seriesColor}}\"\n        ng-attr-[class.active]=\"{{active}}\"\n        ng-attr-[class.inactive]=\"{{inactive}}\"\n        ng-attr-[attr.fill-opacity]=\"{{rangeFillOpacity}}\"\n        ng-attr-[fill]=\"{{hasGradient ? gradientUrl : seriesColor}}\"\n        ng-attr-[animations]=\"{{animations}}\"\n      />\n      <svg:g\n        ngx-charts-circle\n        *ngFor=\"let circle of circles\"\n        class=\"circle\"\n        ng-attr-[cx]=\"{{circle.cx}}\"\n        ng-attr-[cy]=\"{{circle.cy}}\"\n        ng-attr-[r]=\"{{circleRadius}}\"\n        ng-attr-[fill]=\"{{circle.color}}\"\n        ng-attr-[style.opacity]=\"{{inactive ? 0.2 : 1}}\"\n        ngx-tooltip\n        ng-attr-[tooltipDisabled]=\"{{tooltipDisabled}}\"\n        ng-attr-[tooltipPlacement]=\"{{'top'}}\"\n        tooltipType=\"tooltip\"\n        ng-attr-[tooltipTitle]=\"{{tooltipTemplate ? undefined : tooltipText(circle)}}\"\n        ng-attr-[tooltipTemplate]=\"{{tooltipTemplate}}\"\n        ng-attr-[tooltipContext]=\"{{circle.data}}\"\n        (select)=\"select.emit(circle.data)\"\n        (activate)=\"activate.emit({ name: circle.data.series })\"\n        (deactivate)=\"deactivate.emit({ name: circle.data.series })\"\n      ></svg:g>\n    </svg:g>\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush
        })
...
var PieChartComponent = /** @class */ (function (_super) {
    ...
    PieChartComponent = __decorate([
        Component({
            ...
            template: "\n    <ngx-charts-chart\n      ng-attr-[view]=\"{{[width, height]}}\"\n      ng-attr-[showLegend]=\"{{legend}}\"\n      ng-attr-[legendOptions]=\"{{legendOptions}}\"\n      ng-attr-[activeEntries]=\"{{activeEntries}}\"\n      ng-attr-[animations]=\"{{animations}}\"\n      (legendLabelActivate)=\"onActivate($event, true)\"\n      (legendLabelDeactivate)=\"onDeactivate($event, true)\"\n      (legendLabelClick)=\"onClick($event)\"\n    >\n      <svg:g ng-attr-[attr.transform]=\"{{translation}}\" class=\"pie-chart chart\">\n        <svg:g\n          ngx-charts-pie-series\n          ng-attr-[colors]=\"{{colors}}\"\n          ng-attr-[series]=\"{{data}}\"\n          ng-attr-[showLabels]=\"{{labels}}\"\n          ng-attr-[labelFormatting]=\"{{labelFormatting}}\"\n          ng-attr-[trimLabels]=\"{{trimLabels}}\"\n          ng-attr-[maxLabelLength]=\"{{maxLabelLength}}\"\n          ng-attr-[activeEntries]=\"{{activeEntries}}\"\n          ng-attr-[innerRadius]=\"{{innerRadius}}\"\n          ng-attr-[outerRadius]=\"{{outerRadius}}\"\n          ng-attr-[explodeSlices]=\"{{explodeSlices}}\"\n          ng-attr-[gradient]=\"{{gradient}}\"\n          ng-attr-[animations]=\"{{animations}}\"\n          ng-attr-[tooltipDisabled]=\"{{tooltipDisabled}}\"\n          ng-attr-[tooltipTemplate]=\"{{tooltipTemplate}}\"\n          ng-attr-[tooltipText]=\"{{tooltipText}}\"\n          (dblclick)=\"dblclick.emit($event)\"\n          (select)=\"onClick($event)\"\n          (activate)=\"onActivate($event)\"\n          (deactivate)=\"onDeactivate($event)\"\n        />\n      </svg:g>\n    </ngx-charts-chart>\n  ",
...
var PieSeriesComponent = /** @class */ (function () {
    ...
    PieSeriesComponent = __decorate([
        Component({
            ...
            template: "\n    <svg:g *ngFor=\"let arc of data; trackBy: trackBy\">\n      <svg:g\n        ngx-charts-pie-label\n        *ngIf=\"labelVisible(arc)\"\n        ng-attr-[data]=\"{{arc}}\"\n        ng-attr-[radius]=\"{{outerRadius}}\"\n        ng-attr-[color]=\"{{color(arc)}}\"\n        ng-attr-[label]=\"{{labelText(arc)}}\"\n        ng-attr-[labelTrim]=\"{{trimLabels}}\"\n        ng-attr-[labelTrimSize]=\"{{maxLabelLength}}\"\n        ng-attr-[max]=\"{{max}}\"\n        ng-attr-[value]=\"{{arc.value}}\"\n        ng-attr-[explodeSlices]=\"{{explodeSlices}}\"\n        ng-attr-[animations]=\"{{animations}}\"\n      ></svg:g>\n      <svg:g\n        ngx-charts-pie-arc\n        ng-attr-[startAngle]=\"{{arc.startAngle}}\"\n        ng-attr-[endAngle]=\"{{arc.endAngle}}\"\n        ng-attr-[innerRadius]=\"{{innerRadius}}\"\n        ng-attr-[outerRadius]=\"{{outerRadius}}\"\n        ng-attr-[fill]=\"{{color(arc)}}\"\n        ng-attr-[value]=\"{{arc.data.value}}\"\n        ng-attr-[gradient]=\"{{gradient}}\"\n        ng-attr-[data]=\"{{arc.data}}\"\n        ng-attr-[max]=\"{{max}}\"\n        ng-attr-[explodeSlices]=\"{{explodeSlices}}\"\n        ng-attr-[isActive]=\"{{isActive(arc.data)}}\"\n        ng-attr-[animate]=\"{{animations}}\"\n        (select)=\"onClick($event)\"\n        (activate)=\"activate.emit($event)\"\n        (deactivate)=\"deactivate.emit($event)\"\n        (dblclick)=\"dblclick.emit($event)\"\n        ngx-tooltip\n        ng-attr-[tooltipDisabled]=\"{{tooltipDisabled}}\"\n        ng-attr-[tooltipPlacement]=\"{{'top'}}\"\n        ng-attr-[tooltipType]=\"{{'tooltip'}}\"\n        ng-attr-[tooltipTitle]=\"{{getTooltipTitle(arc)}}\"\n        ng-attr-[tooltipTemplate]=\"{{tooltipTemplate}}\"\n        ng-attr-[tooltipContext]=\"{{arc.data}}\"\n      ></svg:g>\n    </svg:g>\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush
        })
    ], PieSeriesComponent);
...
var CardSeriesComponent = /** @class */ (function () {
    ...
    CardSeriesComponent = __decorate([
        Component({
            ...
            template: "\n    <svg:rect\n      *ngFor=\"let c of emptySlots; trackBy: trackBy\"\n      class=\"card-empty\"\n      ng-attr-[attr.x]=\"{{c.x}}\"\n      ng-attr-[attr.y]=\"{{c.y}}\"\n      ng-attr-[style.fill]=\"{{emptyColor}}\"\n      ng-attr-[attr.width]=\"{{c.width}}\"\n      ng-attr-[attr.height]=\"{{c.height}}\"\n      rx=\"3\"\n      ry=\"3\"\n    />\n    <svg:g\n      ngx-charts-card\n      *ngFor=\"let c of cards; trackBy: trackBy\"\n      ng-attr-[x]=\"{{c.x}}\"\n      ng-attr-[y]=\"{{c.y}}\"\n      ng-attr-[width]=\"{{c.width}}\"\n      ng-attr-[height]=\"{{c.height}}\"\n      ng-attr-[color]=\"{{c.color}}\"\n      ng-attr-[bandColor]=\"{{c.bandColor}}\"\n      ng-attr-[textColor]=\"{{c.textColor}}\"\n      ng-attr-[data]=\"{{c.data}}\"\n      ng-attr-[label]=\"{{c.label}}\"\n      ng-attr-[medianSize]=\"{{medianSize}}\"\n      ng-attr-[valueFormatting]=\"{{valueFormatting}}\"\n      ng-attr-[labelFormatting]=\"{{labelFormatting}}\"\n      ng-attr-[animations]=\"{{animations}}\"\n      (select)=\"onClick($event)\"\n    />\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush
        })
    ], CardSeriesComponent);
